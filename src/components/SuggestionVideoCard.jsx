    ...
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex mb-3">
                <div className="relative h-22 lg:h-20 xl:h-24 w-42 min-w-[168px] lg:w-32 lg:min-w-[128px] xl:w-40 xl:min-w-[168px] rounded-lg bg-slate-800 overflow-hidden">
                    <img
                ...
                <div className="flex flex-col ml-3 overflow-hidden">
                    ...
                    <div className="flex text-[12px] lg:text-[10px] xl:text-[12px] font-semibold text-white/[0.7] truncate overflow-hidden">
                        ...
                        <span className="flex text-[24px] leading-none font-bold text-white/[0.7] relative top-[-10px] mx-1 rounded-full">
                            .
                        </span>
